...
function increaseSpeedLevelOne() {
  if (score === 125 && loopBreaker === true) {
    for (let i = 0; i < harmlessToGenerate.length; i++) {
      harmlessToGenerate[i].speed += 2;
    }
    for (var i = 0; i < deadlyToGenerate.length; i++) {
      deadlyToGenerate[i].speed += 2;
    }
    loopBreaker = false;
  }
}

function increaseSpeedLevelTwo() {
  if (score === 250 && loopBreaker === true) {
    for (let i = 0; i < harmlessToGenerate.length; i++) {
      harmlessToGenerate[i].speed += 2;
    }
    for (var i = 0; i < deadlyToGenerate.length; i++) {

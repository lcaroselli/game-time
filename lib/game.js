...
var grass1 = new Platform(0, 700, canvas.width, 100, 'green');
var grass2 = new Platform(0, 400, canvas.width, 100, 'green');
var firepit = new Platform(0, 0, canvas.width, 100, 'orange');
var water = new Platform(0, 100, canvas.width, 300, 'blue');
var road = new Platform(0, 500, canvas.width, 200, 'lightgrey')
